...
welcomeButton.onclick = function () {
    welcomeMessage.textContent =
        "Welcome to Campus Tech Store! Enjoy student-friendly technology deals.";
};
...
offersButton.onclick = function () {
    offersMessage.textContent =
        "Special student offer active: Free delivery and selected item discounts are available today.";
};
...
searchButton.onclick = function () {
    ...
    if (found) {
        ...
        searchResult.textContent =
            "Sorry, this product is not in the current store list.";
    }
};
...
window.onload = function () {
    document.getElementById("welcomeMessage").textContent =
        "Page loaded successfully. Click buttons below to interact.";
};